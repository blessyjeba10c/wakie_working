...
DisplayState displayState = DisplayState();  // Initialize with default constructor
KeyboardState keyboardState = KeyboardState();  // Initialize with default constructor
